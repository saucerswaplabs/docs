...
| Orders disappear during the planned V3 migration | Existing orders are not transferred into new books. Follow the [migration guidance](/protocol/saucerswap-v3/markets#planned-contract-migration) before approving the new reactor and placing new orders. |
