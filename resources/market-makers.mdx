...
SaucerSwap V3 is a central limit order book on Hedera with off-chain matching and on-chain settlement. Professional market makers and bot operators integrate through the Orderbook API, which exposes public market data without authentication and account-scoped trading endpoints behind wallet authentication. This page covers how the market works from a maker's perspective and how to onboard.
