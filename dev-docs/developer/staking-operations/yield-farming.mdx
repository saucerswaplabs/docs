...
* [Deposit LP tokens to a farm](/developer/staking-operations/yield-farming#deposit-lp-tokens-to-a-farm)

* [Get user's current farm reward](/developer/staking-operations/yield-farming#get-users-current-farm-reward)

* [Withdraw LP tokens from a farm](/developer/staking-operations/yield-farming#withdraw-lp-tokens-from-a-farm)
...
[PreviousSingle-Sided Staking](/developer/staking-operations/single-sided-staking)[NextWHBAR](/developer/whbar)
