...
1. [Staking Operations](/developer/staking-operations)
...
* [Get xSAUCE amount from SAUCE](/developer/staking-operations/single-sided-staking#get-xsauce-amount-from-sauce)

* [Stake SAUCE tokens for xSAUCE](/developer/staking-operations/single-sided-staking#stake-sauce-tokens-for-xsauce)

* [Get SAUCE amount from xSAUCE](/developer/staking-operations/single-sided-staking#get-sauce-amount-from-xsauce)

* [Unstake xSAUCE tokens for SAUCE](/developer/staking-operations/single-sided-staking#unstake-xsauce-tokens-for-sauce)

**Contract ID:** [Mothership](https://hashscan.io/mainnet/contract/0.0.1460199)

Refer to [Single-sided staking](https://docs.saucerswap.finance/features/single-sided-staking) for a more detailed documentation.
...
[PreviousStaking Operations](/developer/staking-operations)[NextYield Farming](/developer/staking-operations/yield-farming)
