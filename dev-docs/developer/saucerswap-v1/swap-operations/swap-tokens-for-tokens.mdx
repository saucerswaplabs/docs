...
[PreviousSwap HBAR for Tokens](/developer/saucerswap-v1/swap-operations/swap-hbar-for-tokens)[NextSwap Tokens for HBAR](/developer/saucerswap-v1/swap-operations/swap-tokens-for-hbar)
