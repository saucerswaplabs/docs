...
* [Swap exact tokens for HBAR](/developer/saucerswap-v1/swap-operations/swap-tokens-for-hbar#swap-exact-tokens-for-hbar)

* [Swap tokens for exact HBAR](/developer/saucerswap-v1/swap-operations/swap-tokens-for-hbar#swap-tokens-for-exact-hbar)

* [Swap exact tokens supporting custom fees for HBAR](/developer/saucerswap-v1/swap-operations/swap-tokens-for-hbar#swap-exact-tokens-supporting-custom-fees-for-hbar)
...
[PreviousSwap Tokens for Tokens](/developer/saucerswap-v1/swap-operations/swap-tokens-for-tokens)[NextTrack Swap Events](/developer/saucerswap-v1/swap-operations/track-swap-events)
