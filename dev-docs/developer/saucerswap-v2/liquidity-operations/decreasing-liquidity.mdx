...
To burn the NFT after completely exiting the position, include **burn** in the multi-call. See [Burning the NFT](/developer/saucerswap-v2/liquidity-operations/decreasing-liquidity#burning-the-nft-position).
...
[PreviousClaiming Fees](/developer/saucerswap-v2/liquidity-operations/claiming-fees)[NextStaking Operations](/developer/staking-operations)
