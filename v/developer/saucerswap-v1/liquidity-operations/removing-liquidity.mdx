...
* [Removing HBAR/token liquidity](/v/developer/saucerswap-v1/liquidity-operations/removing-liquidity#removing-hbar-token-liquidity)

* [Removing token/token liquidity](/v/developer/saucerswap-v1/liquidity-operations/removing-liquidity#removing-token-token-liquidity)

* [Removing HBAR/token liquidity for tokens with custom fees](/v/developer/saucerswap-v1/liquidity-operations/removing-liquidity#removing-hbar-token-liquidity-supporting-tokens-with-custom-fees)
