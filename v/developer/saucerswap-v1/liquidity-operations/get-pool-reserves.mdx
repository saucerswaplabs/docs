...
* [Get a pool reserves via REST API](/v/developer/saucerswap-v1/liquidity-operations/get-pool-reserves#get-a-pair-reserves-via-rest-api)

* [Get a pool reserves via JSON RPC](/v/developer/saucerswap-v1/liquidity-operations/get-pool-reserves#get-a-pair-reserves-via-json-rpc)
