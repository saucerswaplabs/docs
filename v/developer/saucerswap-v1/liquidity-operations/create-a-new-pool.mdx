...
* [Creating a new HBAR/token liquidity pool](/v/developer/saucerswap-v1/liquidity-operations/create-a-new-pool#creating-a-new-hbar-token-liquidity-pair)

* [Creating a new token/token liquidity pool](/v/developer/saucerswap-v1/liquidity-operations/create-a-new-pool#creating-a-new-token-token-liquidity-pair)
