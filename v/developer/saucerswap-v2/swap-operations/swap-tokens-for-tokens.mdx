...
* [Swap exact tokens for tokens](/developer/saucerswap-v2/swap-operations/swap-tokens-for-tokens#swap-exact-tokens-for-tokens)

* [Swap tokens for exact tokens](/developer/saucerswap-v2/swap-operations/swap-tokens-for-tokens#swap-tokens-for-exact-tokens)
...
[PreviousSwap HBAR for Tokens](/developer/saucerswap-v2/swap-operations/swap-hbar-for-tokens)[NextSwap Tokens for HBAR](/developer/saucerswap-v2/swap-operations/swap-tokens-for-hbar)
