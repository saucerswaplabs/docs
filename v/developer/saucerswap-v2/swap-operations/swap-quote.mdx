...
* [Get output quote from exact input amount](/developer/saucerswap-v2/swap-operations/swap-quote#get-output-quote-from-exact-input-amount)

* [Get input quote from exact output amount](/developer/saucerswap-v2/swap-operations/swap-quote#get-output-quote-from-exact-input-amount)
...
<Tabs>
  ...
  <Tab title>
    ...
    //QuoterV2.sol contract
    const quoterContract = ContractId.fromString(config.quoter);
...
[PreviousSwap Operations](/developer/saucerswap-v2/swap-operations)[NextSwap HBAR for Tokens](/developer/saucerswap-v2/swap-operations/swap-hbar-for-tokens)
