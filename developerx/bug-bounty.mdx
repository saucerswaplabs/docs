...
>
> SaucerSwap is running a separate V3 testnet bug bounty for the V3 orderbook launch. This program has its own scope, reward bands, submission form, and timeline.
>
> If you are testing the V3 orderbook, review the V3 testnet bug bounty page before submitting a report:
>
> [View V3 testnet bug bounty details](/developerx/bug-bounty/v3-testnet)
