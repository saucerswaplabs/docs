...
- Collection — V1's protocol share is 1/6 of swap fees. Each V2 pool uses its configured 1/N protocol share, where 4 ≤ N ≤ 10. V3 first resolves maker rebates and applicable trader discounts. See [contract deployments](/developers/contracts) for collection and routing contracts.
