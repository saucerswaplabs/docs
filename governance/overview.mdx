...
In case of proposal or election failure, a 2-week cooldown period is required before a new RFC can be submitted, unless this RFC undergoes a substantive change over its original. The determination of whether the change is substantive will be made by SaucerSwap Labs. The RFC must be new and will again be subject to the standard 3-day commentary period before it can proceed to proposal.
