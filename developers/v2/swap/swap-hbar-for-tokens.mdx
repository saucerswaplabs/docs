---
title: "Swap HBAR for tokens (V2)"
description: "Swap HBAR for HTS tokens through the SaucerSwap V2 SwapRouter using exactInput and exactOutput multicalls with refundETH, with TypeScript code examples."
---
...
<CardGroup cols={2}>
  ...
  <Card title="Swap tokens for HBAR (V2)" href="/developers/v2/swap/swap-tokens-for-hbar">
    Run the same flow in the opposite direction.
  </Card>

  <Card title="Track swap events (V2)" href="/developers/v2/swap/track-swap-events">
