---
title: "Swap tokens for HBAR (V2)"
description: "Swap HTS tokens for HBAR through the SaucerSwap V2 SwapRouter using exactInput and exactOutput with unwrapWHBAR multicalls and allowance pre-checks."
---
