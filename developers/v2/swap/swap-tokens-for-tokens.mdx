---
title: "Swap tokens for tokens (V2)"
description: "Swap HTS tokens for other HTS tokens through the SaucerSwap V2 SwapRouter with exactInput and exactOutput, including path encoding with pool fee tiers."
---
