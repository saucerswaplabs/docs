---
title: "Check if a pool exists (V2)"
description: "Check whether a SaucerSwap V2 pool exists for a token pair and fee tier with the factory getPool function before minting a new liquidity position."
---
