---
title: "Increasing liquidity (V2)"
description: "Add more liquidity to an existing SaucerSwap V2 position with increaseLiquidity, including slippage-safe amounts computed with the Uniswap V3 SDK."
---
...
<CardGroup cols={2}>
  <Card title="Decreasing liquidity (V2)" href="/developers/v2/liquidity/decreasing-liquidity">
