---
title: "New liquidity position (V2)"
description: "Mint a new SaucerSwap V2 concentrated liquidity position NFT with the mint multicall, including tick range selection built with the Uniswap V3 SDK."
---
...
<CardGroup cols={2}>
  <Card title="Increasing liquidity (V2)" href="/developers/v2/liquidity/increasing-liquidity">
  ...
  <Card title="Liquidity position fee (V2)" href="/developers/v2/liquidity/liquidity-position-fee">
