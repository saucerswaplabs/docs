---
title: "Decreasing liquidity (V2)"
description: "Decrease or fully exit a SaucerSwap V2 liquidity position with the decreaseLiquidity, collect, unwrapWHBAR, and optional burn calls in one multicall."
---
...
<CardGroup cols={2}>
  ...
  <Card title="Get user positions (V2)" href="/developers/v2/liquidity/get-user-positions">
