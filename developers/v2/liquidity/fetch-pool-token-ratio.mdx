---
title: "Fetch pool token ratio (V2)"
description: "Read the current token price ratio of a SaucerSwap V2 pool with slot0 and the Uniswap V3 SDK to size both token amounts of a new liquidity position."
---
