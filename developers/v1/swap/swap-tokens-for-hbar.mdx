---
title: "Swap tokens for HBAR (V1)"
description: "Swap HTS tokens for HBAR through the SaucerSwap V1 router: exact-input, exact-output, and fee-on-transfer variants with allowance and association checks."
---
...
<CardGroup cols={2}>
  ...
  <Card title="Swap tokens for tokens (V1)" href="/developers/v1/swap/swap-tokens-for-tokens">
