---
title: "Swap tokens for tokens (V1)"
description: "Swap HTS tokens for other HTS tokens through the SaucerSwap V1 router, covering exact-input, exact-output, and fee-on-transfer variants with examples."
---
...
<CardGroup cols={2}>
  <Card title="Swap quote (V1)" href="/developers/v1/swap/swap-quote">
  ...
  <Card title="Swap tokens for tokens (V2)" href="/developers/v2/swap/swap-tokens-for-tokens">
