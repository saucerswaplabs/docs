---
title: "Swap HBAR for tokens (V1)"
description: "Swap HBAR for HTS tokens through the SaucerSwap V1 router: exact-input, exact-output, and fee-on-transfer variants with Hedera SDK TypeScript examples."
---
...
<CardGroup cols={2}>
  ...
  <Card title="Swap tokens for HBAR (V1)" href="/developers/v1/swap/swap-tokens-for-hbar">
