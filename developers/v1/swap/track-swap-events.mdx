---
title: "Track swap events (V1)"
description: "Monitor SaucerSwap V1 Swap events in near real time by polling the Hedera mirror node REST API or the JSON-RPC relay, with log grouping by transaction."
---
