---
title: "Create a new pool (V1)"
description: "Create new SaucerSwap V1 liquidity pools with addLiquidityETHNewPool and addLiquidityNewPool, including the pool creation fee and auto-association setup."
---
...
<CardGroup cols={2}>
  <Card title="Pool creation fee (V1)" href="/developers/v1/liquidity/pool-creation-fee">
    Fetch the current fee before creating a pool.
  </Card>

  <Card title="Check if a pool exists (V1)" href="/developers/v1/liquidity/check-if-a-pool-exists">
