...
The Phase 1 SaucePaymentSplitter uses EVM address `0xf27b41e702ac95312fe005b33e4c5c14d2d722b9`; use this address rather than a long-zero conversion of its Hedera ID. Of its 1,000,000 shares, 700,000 belong to the existing non-staking recipient `0.0.1062644`, and 300,000 belong to `0xdead000000000000000000000000000000000000`. This is a pull-payment splitter: `release(account)` transfers an entitled payee's available SAUCE, so a deposit does not itself forward the funds. See [devcut and additional burn](/tokenomics/overview#devcut-and-additional-burn) for the economic allocation.
