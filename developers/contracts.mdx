...
description: "SaucerSwap contract and token IDs on Hedera mainnet and testnet, with explorer verification, Phase 1 fee routing, V3 signing, and SAUCE on Base."
---
...
| SaucePaymentSplitter | [0.0.10834473](https://hashscan.io/mainnet/contract/0.0.10834473) | Phase 1 Masterchef devcut: 30% burn, 70% existing non-staking route |
| sauceSplitter (legacy) | [0.0.1462981](https://hashscan.io/mainnet/contract/0.0.1462981) | Previous Masterchef devcut recipient, superseded in Phase 1 |
| hbarSplitter | [0.0.1462986](https://hashscan.io/mainnet/contract/0.0.1462986) | Fee distribution splitter |

SaucePaymentSplitter has 1,000,000 shares: 700,000 belong to the existing non-staking recipient `0.0.1062644`, and 300,000 belong to `0xdead000000000000000000000000000000000000`. This is a pull-payment splitter: `release(account)` transfers an entitled payee's available SAUCE, so a deposit does not itself forward the funds. See [devcut and additional burn](/tokenomics/overview#devcut-and-additional-burn) for the economic allocation.
