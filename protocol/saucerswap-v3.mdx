...
<Info>
  As of September 8, 2026, the [approved V3 calibration](https://gov.saucerswap.finance/t/saucerswap-v3-order-book-calibration-contract-migration-market-set-and-fee-configuration/385) has not activated yet. Its planned market set, fee schedule, and contract migration are described in [V3 markets](/protocol/saucerswap-v3/markets) and [V3 fees](/protocol/saucerswap-v3/fees). Check the app for the markets and effective fees available when you trade.
</Info>
...
The approved calibration also adds comparison between AMM and order-book quotes in the trade flow. That planned routing feature is separate from AMM-backed settlement and is not yet active. See [Swap routing](/protocol/routing) for the selection rules and activation distinction.
...
<CardGroup cols={2}>
  ...
  <Card title="V3 markets" icon="list" href="/protocol/saucerswap-v3/markets">
    Understand market parameters and the planned calibration.
  </Card>
