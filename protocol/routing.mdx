...
The swap router does not currently compare an AMM swap quote with an order-book quote. That cross-venue comparison is proposed in [governance thread 385](https://gov.saucerswap.finance/t/v3-order-book-calibration-contract-migration-market-set-and-fee-configuration/385), which remains RFC-only and has not been ratified or verified as deployed.
