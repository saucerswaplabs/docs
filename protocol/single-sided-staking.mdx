...
1. **Swap Fees:** A portion of the 1/6 fee collected by the protocol from all SaucerSwap V1 and V2 liquidity pools.
2. **Farm Emissions:** 30% of the Masterchef contract's devcut.
