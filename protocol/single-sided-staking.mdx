...
2. **Farm Emissions:** 30% of the Masterchef contract's devcut, currently set at 17.30 SAUCE per minute.
...
Infinity Pool APR=\[Ri​Rf​​−1]×365

Where:

* R represents the exchange rate, given by *SAUCE/xSAUCE* in the Infinity Pool.

* Ri​ and Rf​ represent the exchange rates at the initial and final times, respectively.

* The rate updates once per day at random, implying Δt≈24h.

[PreviousLARI Weights](/protocol/saucerswap-v2/lari-weights)[NextCommunity Pools](/protocol/community-pools)
