...
Net order book fees — taker fees after applicable trader discounts, less maker rebates paid — fund SAUCE buybacks through Unified BrewSaucer. Purchased SAUCE follows the same allocation as the other eligible revenue sources: 40% to Mothership/xSAUCE, 30% to the Development Fund, 10% to burn, and 20% to the POL + Incentive Reserve. Maker rebates remain funded upstream from taker fees; V3 does not receive SAUCE emission incentives. See [SAUCE tokenomics](/tokenomics/overview#unified-brewsaucer-buybacks-and-burn) for the full revenue flow.
