...
Traders pay a fee on every trade: a percentage of each AMM swap, or a taker fee on order-book fills. Most of each AMM fee goes to liquidity providers, while protocol fee-switch revenue and net V3 fees fund SAUCE buybacks through BrewSaucer. Unified BrewSaucer routes purchased SAUCE consistently across eligible revenue sources: 40% to xSAUCE, 30% to development, 10% to burn, and 20% to protocol-owned liquidity and incentives. See [SAUCE tokenomics](/tokenomics/overview) for the full allocation.
