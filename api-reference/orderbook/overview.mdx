...
<Note>
  Public reads are rolling out network by network: as of July 9, 2026 they are live on testnet, while the mainnet endpoints still require a JWT. See [market data](/api-reference/orderbook/market-data) for the current status.
</Note>
