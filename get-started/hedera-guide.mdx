...
<Card title="" horizontal={true} href="/get-started/hedera-guide/create-hedera-wallet">
  ## <Icon icon="link-simple" size={20} />    Create Hedera Wallet
</Card>

<Card title="" horizontal={true} href="/get-started/hedera-guide/get-hbar">
  ## <Icon icon="link-simple" size={20} />    Get HBAR
</Card>

<Card title="" horizontal={true} href="//get-started/hedera-guide/bridge-to-hedera">
  ## <Icon icon="link-simple" size={20} />    Bridge To Hedera
</Card>
