...
- V3 AMM-backed settlement — eligible V3 orders can opt into the live one-way AMM backstop. Cross-venue AMM-versus-order-book quote comparison remains RFC-only in [thread 385](https://gov.saucerswap.finance/t/v3-order-book-calibration-contract-migration-market-set-and-fee-configuration/385).
