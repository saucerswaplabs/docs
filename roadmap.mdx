...
- Comprehensive web app redesign — updated navigation, transaction flow, token menu, and mobile responsiveness.
...
- V3 soft relaunch — updated [markets and minimum orders](/protocol/saucerswap-v3/markets), [market-specific fees and rebates](/protocol/saucerswap-v3/fees), and comparison of AMM and order-book quotes on the swap page. Eligible V3 orders can also use the separate AMM backstop; see [Swap routing](/protocol/routing).
