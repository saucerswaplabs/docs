...
<Frame caption="SAUCE max supply by allocation category.">
  ![Chart of the SAUCE maximum supply split across allocation categories](/images/diagrams/tokenomics-allocation.svg)
</Frame>
...
<Frame caption="How Masterchef emissions flow to farms, LARI, the DAO, and staking.">
  ![Diagram of the SAUCE emission flow from the Masterchef contract to reward destinations](/images/diagrams/emission-flow.svg)
</Frame>
