...
| Source | xSAUCE | Development | Burn | POL + incentive reserve |
| --- | --: | --: | --: | --: |
| V1/V2 fee-switch revenue + HBAR staking rewards | 50% | 10% | 10% | 30% |
| V3 net fees | 30% | 60% | 10% | 0% |
| Masterchef devcut | 100% | 0% | 0% | 0% |
...
<Info>
  Governance forum text establishes the proposal's scope and chronology; the final passing election establishes ratification. [Thread 385](https://gov.saucerswap.finance/t/v3-order-book-calibration-contract-migration-market-set-and-fee-configuration/385) remains RFC-only and is not an operative economics or routing decision.
</Info>
