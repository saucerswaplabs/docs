...
## <u>How to Add Token Icon/Logo</u>
...
Metadata should follow the [Hedera fungible token Metadata schema](https://hips.hedera.com/hip/hip-405#schema).

### For tokens without an admin or metadata key

Token icon and information can be added & updated on [Davinci Pics](https://davincigraph.io/#pics_home)

Adding or updating a token icon on Davinci Pics requires connecting either:
